    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def err_screen1():
                ...
                Label(errsc2, text='Please enter Student & F_Contact!!!', fg='black', bg='white',
            ...
            ENR = tk.Label(MFW, text="Enter F_Contact", width=15, height=2, fg="black", bg="grey",
                           font=('times', 15))
            ...
            def enter_data_DB():
                ...
                if F_Contact == '':
                    ...
                    Insert_data = "INSERT INTO " + DB_table_name + \
                        " (ID,F_Contact,NAME,DATE,TIME) VALUES (0, %s, %s, %s,%s)"
                    VALUES = (str(F_Contact), str(
...
def err_screen():
    ...
    Label(sc1, text='F_Contact & Name required!!!', fg='black',
    ...
    if l1 == '':
        ...
        try:
            ...
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("TrainingImage/ " + Name + "." + F_Contact + '.' + str(sampleNum) + ".jpg",
                                gray)
                    print("Images Saved for F_Contact :")
            ...
            with open('StudentDetails\StudentDetails.csv', 'a+') as csvFile:
                ...
                writer.writerow(row)
                csvFile.close()
            res = "Images Saved for F_Contact : " + F_Contact + " Name : " + Name
...
lbl = tk.Label(window, text="Enter F_Contact : ", width=20, height=2,
               fg="black", bg="grey", font=('times', 15, 'bold'))
