...
window = tk.Tk()
window.title("SFRS-Student's Face Recognition System")
...
def manually_fill():
    ...
    def fill_attendance():
        ...
        if subb == '':
            ...
            def err_screen1():
                ...
                Label(errsc2, text='Please enter Details!!!', fg='black', bg='white',
            ...
            ENR = tk.Label(MFW, text="Enter Father's Contact", width=20,height=2, fg="black", bg="grey",
                           font=('times', 15))
            ENR.place(x=30, y=100)

            STU_NAME = tk.Label(MFW, text="Enter Student's Name", width=20, height=2, fg="black", bg="grey",
                                font=('times', 15))
            ...
            def create_csv():
                ...
                csv_name = 'D:\softwares\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(
                    r'explorer /select,"D:\softwares\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\Attendance\Manually Attendance\-------Check atttend0ance-------"')
    ...
    fill_manual_attendance = tk.Button(sb, text="Scan", command=fill_attendance, fg="black", bg="SkyBlue1", width=20, height=2,
                                       activebackground="white", font=('times', 15, ' bold '))
...
def err_screen():
    ...
    Label(sc1, text='Enter Details!!!', fg='black',
        ...
        try:
            ...
            while (True):
                ...
                for (x, y, w, h) in faces:
                    ...
                    cv2.imwrite("TrainingImage/ " + Name + "." + F_Contact + '.' + str(sampleNum) + ".jpg",
                                gray)
                    print("Images Saved :")
            ...
            Time = datetime.datetime.fromtimestamp(ts).strftime('%H:%M:%S')
            row = [F_Contact, Name, Date, Time]
            with open('StudentDetails\StudentDetails.csv', 'a+') as csvFile:
                writer = csv.writer(csvFile, delimiter=',')
                writer.writerow(row)
                csvFile.close()
            res = "Images Saved F's Contact: " + F_Contact + " Name : " + Name
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                col_names = ['F_Contact', 'Name', 'Date', 'Time']
                    ...
                    for (x, y, w, h) in faces:
                        ...
                        if (conf < 70):
                            ...
                            timeStamp = datetime.datetime.fromtimestamp(
                                ts).strftime('%H:%M:%S')
                            aa = df.loc[df['F_Contact'] == Id]['Name'].values
                            global tt
                            tt = str(Id) + "-" + aa
                            En = '15624031' + str(Id)
                ...
                root.configure(background='grey80')
                cs = 'D:\softwares\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main/' + fileName
    ...
    windo.title("Enter subject named...")
    ...
    def Attf():
        import subprocess
        subprocess.Popen(
            r'explorer /select,"D:\softwares\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\Attendance\-------Check atttendance-------"')
    ...
    fill_a = tk.Button(windo, text="Scan", fg="white", command=Fillattendances, bg="SkyBlue1", width=20, height=2,
                       activebackground="white", font=('times', 15, ' bold '))
    ...
    def log_in():
        ...
        if username == 'snooper':
            if password == 'drowssap':
                ...
                cs = 'D:\softwares\Face-Recognition-Attendance-System-main\Face-Recognition-Attendance-System-main\StudentDetails\StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="Student's Face Recognition System", bg="black", fg="white", width=50,
...
lbl = tk.Label(window, text="Enter Father's Contact : ", width=20, height=2,
               fg="black", bg="grey", font=('times', 15, 'bold'))
...
lbl2 = tk.Label(window, text="Enter Student's Name \n & Course    : \n[Amit - BCA-I]", width=20, fg="black",
                bg="grey", height=3, font=('times', 15, ' bold '))
...
AP = tk.Button(window, text="View Student's Details", command=admin_panel, fg="black",
...
FA = tk.Button(window, text="Scan a Face", fg="black", command=subjectchoose,
               bg="SkyBlue1", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
FA.place(x=690, y=500)

quitWindow = tk.Button(window, text="Enter Data Manually", command=manually_fill, fg="black",
                       bg="SkyBlue1", width=20, height=3, activebackground="white", font=('times', 15, ' bold '))
